  ...
  return `<div class='col-4'>
              <div class="card  well text-center">
                ...
                <div class="card-content">
                  ...
                  <a onclick="movieSelected('${result.id}')" class  ="movieDetails btn btn-primary" href="#">Movie Details</a>
                </div>
              </div>
        </div>`;
}
  ...
  return `<div class="container">
           ...
           <div class="col-6">
              ...
              <div class="col-6 movieInfo">
                ...
                <p>Genres: <span>${result.genres.name}</span></p>
                <p>Release Date : <span>${result.release_date}</span></p>
                <p>Home page : <span><a href=${result.homepage}>${result.homepage}</a></span></p>
